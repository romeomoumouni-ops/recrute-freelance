...
// Bouton "Continuer avec Google". `role` (optionnel) définit le profil créé si c'est une
// première inscription (transmis au callback via ?newrole=).
export default function GoogleAuthButton({
  ...
  return (
    <button
      ...
      disabled={loading}
    >
      <GoogleIcon /> {loading ? 'Redirection…' : label}
    </button>
  );
}
